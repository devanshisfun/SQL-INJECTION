...
$cat=mysqli_query($con,"select * from `categeory`");
include("header.php");
?>		
			<!-- Main Content -->
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Manage Place</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							<li><a href="index">Dashboard</a></li>
							<li class="active"><span>Manage Place</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
											...
											<table id="example" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														...
														<td>
														   <a class='edit btn btn-sm btn-primary' href='./cate_delete?id=<?php echo $row['code']; ?>' onclick='return checkdelete()'>Delete</a>
														</td>
													</tr>
												<?php
													$i++;
