...
$password2=stripcslashes($password1);

$name=mysqli_real_escape_string($con,$name2);
$password=mysqli_real_escape_string($con,md5($password2));
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Secure Login</h3>
